openerp.hotel_book = function(openerp) {
    var _t = openerp.web._t;
    _lt = openerp.web._lt;
    var QWeb = openerp.web.qweb;

    openerp.hotel_book.RoomSummary1 = openerp.web.form.FormWidget.extend(openerp.web.form.ReinitializeWidgetMixin,
    {
        ...
        init: function() {
	    	...
	    	if(this.field_manager.model == "hotel.reservation.summary")
	    	{
      ...
      renderElement: function() {
             this.destroy_content();
             this.$el.html(QWeb.render("ReservationTemplate", {widget: this}));
        }
    });
    openerp.web.form.custom_widgets.add('Room_Reservation', 'openerp.hotel_book.RoomSummary1');
